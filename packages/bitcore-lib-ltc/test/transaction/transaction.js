...
describe('Transaction', function() {
  ...
  const privateKey = 'T5KGNx3kN82DX3ptyEfxxTmy6p35NYeHvqWAJYoH5KPiiA8q8sR1';
  // Addresses from the privateKey
  const fromAddress = 'LhZbhtJu6Mdd1aVSEUk2hXdYRjqnmU51wf';
  const witnessFromAddress = 'ltc1q75y76yvdnfunehav0s349t2ltxfv85rkeg53uj';
  const wrappedWitnessFromAddress = '3JnKsXD4Zyw1R7S99aCXZ6yAZKtS7tQpFZ';
  ...
  const toAddress = 'LhZbhtJu6Mdd1aVSEUk2hXdYRjqnmU51wf';
  const changeAddress = 'LLNuCH6vzj64JtgkG5PqZC2HGHfhmecBWM';
  const changeAddressP2SH = '3JnKsXD4Zyw1R7S99aCXZ6yAZKtS7tQpFZ';
  const changeAddressP2WPKH = 'ltc1q75y76yvdnfunehav0s349t2ltxfv85rkeg53uj';
  const changeAddressP2WSH = 'ltc1q5hmqsvn76tmmwxqu38v0m2ehjh8purszceshk6h0q62sf5gac9rs9apjr3';
  // Create some keys for multi-sig
  const private1 = '9d7cb4e809183b43e0c419cdbdf30d9c43b42cab1e8f853464451fe81f24473c';
  const private2 = 'c4fc4d21072af51d86456fadcfc987f870f0a5de659183f2b5b5ce0d606e4f62';
  const signingKey1 = new PrivateKey(private1).publicKey;
  const signingKey2 = new PrivateKey(private2).publicKey;

  const simpleUtxoWith1LTC = {
    address: fromAddress,
    txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
    outputIndex: 1,
    script: Script.buildPublicKeyHashOut(fromAddress).toString(),
  ...
  const simpleWitnessUtxoWith1LTC = {
  ...
  const simpleWrappedWitnessUtxoWith1LTC = {
  ...
  describe('Segregated Witness', function() {
    ...
    describe('signing', function() {
      const privateKey1 = PrivateKey.fromWIF('cSoipxn2gvwf7QkkGqQP937kRAVdG4yEukMPoTJ3xDpRsVBQUodw');
      const publicKey1 = privateKey1.toPublicKey();
      const privateKey2 = PrivateKey.fromWIF('cReQL2geaNaSpaND7Rb2VU3K1dukzqbHaWbc6Jk2tBhp8F9cNf7T');
      const publicKey2 = privateKey2.toPublicKey();
      const privateKey3 = PrivateKey.fromWIF('cRKXxFHKMzPPMEHdTSERSoetJq526Ti5zpEEUmbj2dquBG9j49d7');
