...
describe('Transaction', function() {
  ...
  const testScript = 'OP_DUP OP_HASH160 20 0x399e6af986692f116cb67431b10ae6bdf8891eb1 OP_EQUALVERIFY OP_CHECKSIG';
  const testScriptHex = '76a914399e6af986692f116cb67431b10ae6bdf8891eb188ac';
  ...
  it('will not accept NaN as an amount', function() {
    (function() {
      const stringTx = new Transaction().to('DGYdw7jC17b9SappjsrAsaghhDTS8sV5Mx', NaN);
  ...
  const fromAddress = 'DSw2NHz2YfTeFogjeGJvZVVZkjkxSSX3zx';
  const witnessFromAddress = 'bc1qau9yky5ct9q0gfeyc8qrcpzgsj5g59zs4ynlu8';
  const wrappedWitnessFromAddress = 'A6wuuhLY2ctoF4H93aeVx8vLgeGFgE1Wxx';
  const simpleUtxoWith10DOGE = {
    address: fromAddress,
  ...
  const anyoneCanSpendUTXO = JSON.parse(JSON.stringify(simpleUtxoWith10DOGE));
  anyoneCanSpendUTXO.script = new Script().add('OP_TRUE');
  const toAddress = 'DE1wEbm9D6JqEhqGtyD52BkHQmQ5N18J84';
  const changeAddress = 'DAPkqFzgrXVsUU7WkSf1GYMmFzEGvuK4SK';
  const changeAddressP2SH = 'A7HRQk3GFCW2QasvdZxXuYj8kkQK5QrYLs';
  const privateKey = 'dd7bdefb163b31eb706ec43589c24cd27fc7878216836468bf216845c7c4aa1c';
  const private1 = '74a605e8593ace50e1a5d20a57ae7bf3a172d6b4d5d9280ee5519946ec1a039b';
  const private2 = '62314e4414b9deb3ce85e4d512c2fbce52a48804e7412a8dec6201f0f996cc82';
  const public1 = new PrivateKey(private1).publicKey;
  const public2 = new PrivateKey(private2).publicKey;

  const thousandDOGE = 1000e8;

  const simpleUtxoWith1000DOGE = {
    address: fromAddress,
    txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
    outputIndex: 1,
    script: Script.buildPublicKeyHashOut(fromAddress).toString(),
  ...
  const simpleWitnessUtxoWith1000DOGE = {
    address: fromAddress,
  ...
  const simpleWrappedWitnessUtxoWith1000DOGE = {
    address: fromAddress,
  ...
  const p2shPrivateKey3 = PrivateKey.fromWIF('ckrhHfB5k7NzVEqEsksYGvh2xSjZiT71oVGGSysP97bGMCkm3EgK');
  ...
  describe('change address', function() {
    ...
    it('fee per kb can be set up manually', function() {
      const inputs = new Array(10).fill(0).map(function(_, i) {
        const utxo = JSON.parse(JSON.stringify(simpleUtxoWith10DOGE));
        utxo.outputIndex = i;
        return utxo;
      });
      const feeRate = 8000;
  ...
  describe('Segregated Witness', function() {
    ...
    describe('signing', function() {
      const privateKey1 = PrivateKey.fromWIF('QQWs5STTjnuVVWBsKwaZtc8SCzzKGDf5iZ6qgZyaPqqDEjLmF5tA');
      const publicKey1 = privateKey1.toPublicKey();
      const privateKey2 = PrivateKey.fromWIF('QQWs5STTjnuVVWBsKwaZtc8SCzzKGDf5iZ6qgZyaPqqDEjLmF5tA');
      const publicKey2 = privateKey2.toPublicKey();
      const privateKey3 = PrivateKey.fromWIF('QQWs5STTjnuVVWBsKwaZtc8SCzzKGDf5iZ6qgZyaPqqDEjLmF5tA');
      ...
      it('will sign with nested p2sh witness program', function() {
        const tx = new Transaction()
          ...
          .sign(privateKey1);
        const sighash = tx.inputs[0].getSighash(tx, privateKey1, 0, bitcore.crypto.Signature.SIGHASH_ALL);
